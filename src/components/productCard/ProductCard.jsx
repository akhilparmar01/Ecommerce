...
function ProductCard() {
     // Access the context to manage state and theme mode
    const context = useContext(myContext)
    const { mode, product ,searchkey, setSearchkey,filterType,setFilterType,
        filterPrice,setFilterPrice} = context

        
    // Access Redux dispatch and state for the shopping cart
  ...
  // Update local storage when the shopping cart changes
    useEffect(() => {
